...
\begin{figure}[!htb]                                                               
   \centering                                                                      
   \includegraphics[keepaspectratio=true]{figuras/Resultado1.eps}                     
\end{figure}

\begin{figure}[!htb]                                                               
   \centering                                                                      
   \includegraphics[keepaspectratio=true]{figuras/Teste14_1.eps}                       
\end{figure}
...
\begin{figure}[!htb]                                                               
   \centering                                                                      
   \includegraphics[keepaspectratio=true]{figuras/Teste12_1.eps}                     
\end{figure}
...
\begin{figure}[!htb]                                                               
   \centering                                                                      
   \includegraphics[keepaspectratio=true]{figuras/Resultado2.eps}                       
\end{figure}
