...
\end{figure}	
\begin{itemize}
	\item {\bf Sensor de Temperatura para a tubulação e para o reservatório:}
	\begin{itemize}
		\item{\bf Modelo:} Sensor de Temperatura DS18B20;
		\item {\bf Descrição:} Sensor de temperatura versão à prova de água do sensor DS18B20; 
		\item{\bf Material de composição:}
		\begin{itemize}
			\item{\bf Ponteira:} aço inoxidável.
		\end{itemize}
		\item{\bf Faixa de temperatura:} de $ -55^oC$ até $+125^oC$;
		\item {\bf Precisão:} $\pm0,5^oC$ na faixa de $-10^oC a +85^oC$; 
		\item {\bf Alimentação:} 5 VDC;
		\item {\bf Tempo de resposta:} menor que 750 ms;
		\item {\bf Dimensões:}
		\begin{itemize}
